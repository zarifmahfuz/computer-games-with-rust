...
pub struct Game {
    ...
    pub predict_grid1: Vec<Vec<i32>>,
    pub predict_grid2: Vec<Vec<i32>>,
    pub count_max_three_consec: i32,
    pub count_min_three_consec: i32,
...
impl Game {
    ...
    pub fn player_1_move(&mut self, col: usize, TO: i32) -> (i32, i32) {
        ...
        if self.grid[0][col as usize] == self.empty {
            ...
            if TO == 0 {
                ...
                self.grid[select_row][col] = self.max;
            }
    ...
    // returns (x, y) if move was successfully made, (-1, -1) if unsuccessful
    pub fn player_2_move(&mut self, col: usize) -> (i32, i32, i32) {
        ...
        self.moves_made += 1;
        self.to_move = -self.to_move;
        return (select_row as i32, col_to_move as i32, TO_flag);
    }
...
fn minimax(st: &mut Game, height: i32, mut alpha: i32, mut beta: i32) -> (i32, i32, i32) {
